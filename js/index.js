...
data.forEach( function(entry){
  ...
  // elements are always created in two steps
  ...
  // now, let's give the element the right color
  var colour = '';
  
  var colourScale = chroma.scale('RdBu').domain([1,-1]);
  colour = colourScale(entry.temperature);
  
  // dark blue: temperature is under -0.5°
  // light blue: temperature is under -0.25°
  // grey: tempearture is between -0.25° and + 0.25°
